...
6. Ajout d’une recherche et de filtres opérationnels sur les centres : ville, type de don et disponibilité.
7. Renforcement de l’algorithme d’éligibilité : âge, poids, sexe, délai post-don et premier don.
8. Remplacement de l’icône générique par une icône féminine dédiée dans le formulaire.
9. Ajout d’icônes de centre aux boutons « Trouver un centre » et « Voir tous les centres ».
10. Ajout de `vercel.json` pour assurer le fonctionnement des routes React sur Vercel.

## Ajustements manuels effectués

- Synchronisation de la jauge Toastify avec la durée de disparition du toast grâce à la barre de progression native.
